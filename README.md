...
This project is a containerized backend system composed of a Spring MVC application, three FastAPI microservices, and a PostgreSQL database. All services are orchestrated using Docker Compose.
